...
metaTitle: "How to Respond to Plan Check Corrections | Permit Guide"
...
image: "https://www.cadtri.com/images/blog/plan-check-correction-response.svg"
faq:
  - q: "What are plan check corrections?"
    a: "Plan check corrections are formal notices issued by a city plan checker after reviewing submitted construction documents. They identify missing information, unclear details, or code compliance issues that must be resolved before permit approval can proceed. They may be provided as PDF markups with code references or as simple numbered lists depending on the jurisdiction."
  - q: "How do I respond to plan check corrections?"
    a: "A proper response includes three elements: revised drawings with clear redlines using revision clouds, delta symbols, and updated dates; a detailed response letter that addresses every correction individually using the city's numbering sequence; and updated supplemental documents such as revised structural calculations or energy reports if the corrections require them."
  - q: "How long does it take to get through plan check corrections?"
    a: "The turnaround depends on city backlog, staffing levels, project complexity, and the quality of the resubmittal package. A complete and well-organized response consistently moves faster than one that requires additional clarification. Some cities offer expedited or over-the-counter review for smaller correction packages."
  - q: "What are the most common mistakes when responding to plan check corrections?"
    a: "The most common mistakes include responding to only part of a correction comment when it contains multiple sub-items, submitting revised plans without visible revision clouds so the reviewer cannot find the changes, ignoring smaller comments while focusing on structural revisions, and making undocumented changes to the drawings unrelated to the city's requested corrections."
---
...
What determines whether a project moves quickly toward [permit approval](/process) is not the existence of corrections. It is the quality of the response.
...
![4-step plan check correction response process: categorize, revise drawings, write response letter, resubmit](/images/blog/plan-check-correction-response.svg)

## What Are Plan Check Corrections?

During the construction permit review process, a city plan checker reviews the submitted [architectural drawings](/architectural-drafting-services), structural calculations, energy reports, and supporting documentation tied to the permit application.
...
Whether the project involves [residential permits](/industries/residential), [tenant improvements](/services/tenant-improvement-packages), additions, or [commercial construction](/industries/commercial), CADTRI provides professional support for complex correction responses and streamlined permit resubmittals.
