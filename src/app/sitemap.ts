...
const INDUSTRIES_DATE = "2026-07-15";
...
export default function sitemap(): MetadataRoute.Sitemap {
  const staticRoutes: MetadataRoute.Sitemap = [
    ...
    { url: `${base}/terms`,          lastModified: SITE_LAUNCH },
    { url: `${base}/privacy-policy`, lastModified: SITE_LAUNCH },
    { url: `${base}/cookie-policy`,  lastModified: SITE_LAUNCH },
  ];
