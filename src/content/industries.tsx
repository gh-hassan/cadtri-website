...
export const industries: readonly Industry[] = [
  {
    ...
    overview: (
      <>
        Residential construction drafting requires careful coordination between design intent,
        zoning requirements, and jurisdiction-specific permit standards.{" "}
        ...
        {" "}prepares complete residential construction documents for single-family homes,
        accessory dwelling units, garage conversions, room additions, pool and spa installations,
        and interior remodeling projects. Every permit-ready residential plan is built around the
        applicable building department checklist before drafting begins, helping the submission
        reach permit review fully organized and ready for approval.
      </>
    ),
    challenges: [
      {
      ...
      },
      {
        ...
        description: (
          <>
            California residential projects require certified{" "}
            <Link href="/services/title-24-energy-compliance" className="underline underline-offset-2 decoration-muted/40 hover:text-secondary hover:decoration-secondary transition-colors duration-150">Title 24</Link>
            {" "}documentation alongside the architectural residential drawings. We coordinate
            energy compliance as part of the full construction drawing package so the permit
            submission is complete from day one.
          </>
        ),
      },
      {
        ...
        description: (
          <>
            California ADU regulations override many local restrictions, but every jurisdiction
            applies them differently. Our{" "}
            <Link href="/services/adu-permit-packages" className="underline underline-offset-2 decoration-muted/40 hover:text-secondary hover:decoration-secondary transition-colors duration-150">ADU permit</Link>
            {" "}plans are researched for the applicable city before drafting begins, including
            setbacks, parking exemptions, height limitations, and owner occupancy requirements.
          </>
        ),
      },
      {
        ...
        description: (
          <>
            Residential permit drawings frequently receive correction comments during the initial
            review cycle.{" "}
            <Link href="/services/city-comments-response" className="underline underline-offset-2 decoration-muted/40 hover:text-secondary hover:decoration-secondary transition-colors duration-150">Our response packages</Link>
            {" "}include clouded revisions, updated residential construction documents, and formal
            response letters organized for efficient re-review and faster permit workflow
            completion.
          </>
        ),
      },
  ...
  },
  {
    ...
    description: (
      <>
        General contractors, developers, and architects rely on{" "}
        <Link href="/" className="underline underline-offset-2 decoration-white/30 hover:text-secondary hover:decoration-secondary transition-colors duration-150">CADTRI</Link>
        {" "}for commercial architectural drafting services, permit-ready commercial drawings,
        tenant improvement packages, and multi-discipline construction documentation built for
        efficient permit approval.
      </>
    ),
    overview: (
      <>
        Commercial projects require a higher level of coordination, code compliance review, and
        production accuracy than typical residential work. CADTRI provides commercial drafting
        services and commercial construction drawing services for tenant improvements, new
        commercial construction, and complex multi-discipline developments. We support
        ...
        , MEP, and{" "}
        <Link href="/services/bim-coordination" className="underline underline-offset-2 decoration-border hover:text-secondary hover:decoration-secondary transition-colors duration-150">BIM coordination</Link>
        {" "}reviews before submission to reduce conflicts during plan check. Production schedules
        are aligned with permit deadlines and contractor timelines so commercial projects
        continue moving without unnecessary delays.
      </>
    ),
    challenges: [
      {
        ...
        description: (
          <>
            Commercial permit drawings require coordinated architectural, structural, mechanical,
            ...
            {" "}manages cross-discipline review, BIM integration, and engineering coordination
            drawings to reduce dimensional conflicts, reference gaps, and field coordination
      ...
      },
      {
        ...
        description: (
          <>
            <Link href="/services/tenant-improvement-packages" className="underline underline-offset-2 decoration-muted/40 hover:text-secondary hover:decoration-secondary transition-colors duration-150">Tenant improvements</Link>
            {" "}and commercial renovations require occupancy classification review, ADA
            accessibility analysis, exiting compliance, and zoning compliance drawings as part
            of the permit process. We complete these reviews early so code requirements are
            integrated directly into the commercial construction drawings instead of added later
            as corrections.
          </>
        ),
      },
  ...
  },
  {
    ...
    overview: (
      <>
        Hospitality projects involve a level of regulatory coordination that goes beyond
        standard commercial construction. Health department approvals, occupancy load
        calculations, ADA accessibility compliance, life safety documentation, and in many
        cases historic district or design review approvals must all work together within a
        single hospitality permit package. CADTRI provides hospitality architectural drafting,
        hotel construction drawings, restaurant architectural drafting, and hospitality{" "}
        <Link href="/services/bim-coordination" className="underline underline-offset-2 decoration-border hover:text-secondary hover:decoration-secondary transition-colors duration-150">BIM coordination services</Link>
        {" "}for restaurants, hotels, hospitality renovations, and commercial food service
        projects. Our hospitality CAD drafting services are built to consolidate every agency
        requirement into one coordinated construction-ready submission, reducing review delays
        and protecting project timelines.
      </>
    ),
    challenges: [
      {
      ...
      },
      {
        ...
        description: (
          <>
            Hospitality fit-outs often require extensive HVAC systems, plumbing systems,
            electrical coordination, and commercial kitchen layout drafting. CADTRI coordinates{" "}
            ...
            , and architectural documentation into one unified hospitality construction
            documentation package to reduce field conflicts and streamline permit review.
          </>
        ),
      },
      {
  ...
  },
  {
    ...
    overview: (
      <>
        Mixed-use developments combine ground floor commercial spaces with residential units
        above, creating a construction documentation process that must address multiple
        occupancy classifications, fire separation requirements, vertical MEP coordination, and
        multi-agency permit approvals. CADTRI delivers integrated mixed-use construction
        drawings, mixed-use BIM coordination, and permit-ready mixed-use documentation from
        early feasibility studies and entitlement exhibits through final jurisdiction submission.
        Rather than treating the project as separate{" "}
        <Link href="/industries/residential" className="underline underline-offset-2 decoration-border hover:text-secondary hover:decoration-secondary transition-colors duration-150">residential</Link>
        {" "}and{" "}
        <Link href="/industries/commercial" className="underline underline-offset-2 decoration-border hover:text-secondary hover:decoration-secondary transition-colors duration-150">commercial</Link>
        {" "}packages, we coordinate the development as one connected scope. Our mixed-use
        drafting services support developers, architects, and contractors with
        construction-ready multi-use building plans, zoning compliance documentation, phased
        construction documentation, and coordinated mixed-use construction drawings built for
    ...
    challenges: [
      ...
      },
      {
        ...
        description: (
          <>
            Large mixed-use developments often phase permits across shell, core, and{" "}
            <Link href="/services/tenant-improvement-packages" className="underline underline-offset-2 decoration-muted/40 hover:text-secondary hover:decoration-secondary transition-colors duration-150">tenant improvement</Link>
            {" "}stages. CADTRI structures phased construction documentation to maintain
            continuity between permit submissions while reducing coordination gaps across the
      ...
      },
      {
        ...
        description: (
          <>
            Stacking residential and commercial occupancies creates complex structural systems
            and vertical MEP routing conditions.{" "}
            <Link href="/" className="underline underline-offset-2 decoration-muted/40 hover:text-secondary hover:decoration-secondary transition-colors duration-150">CADTRI</Link>
            {" "}manages{" "}
            ...
            {" "}for mixed-use projects across architectural, structural, and MEP disciplines so
            the final mixed-use construction documentation reflects a coordinated, buildable
            design before it reaches plan check.
          </>
        ),
      },
    ],
